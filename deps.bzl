...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:p6pVkEJLKQ5dxtvkfpkAZrIPPETchOOFXeo5EMbyj/0=",
        version = "v1.0.1",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_goombaio_namegenerator",
        importpath = "github.com/goombaio/namegenerator",
        sum = "h1:XmA6L9IPRdUr28a+SK/oMchGgQy159wvzXA5tJ7l+40=",
